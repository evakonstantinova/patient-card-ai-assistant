...
def analyze_with_ai(text, analysis_type):
    prompt = f"""
You are an AI research assistant specializing in MRI, medical imaging, CNNs, HQNNs, and healthcare AI.

Analyze the uploaded document and return ONLY valid JSON.

Do not include markdown.
Do not include explanations outside the JSON.
Do not invent information. If something is missing, write "Not clearly stated".
